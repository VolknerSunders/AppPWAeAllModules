...
class SuggestedProduct extends Component<any, any> {
     ...
     render() {
          ...
          if(MyList.length>0){
               const MyView = MyList.map((ProductList:any,i:any)=>{
             ...
             <p className="product-name-on-card">{ProductList.title}</p>
              ...
              <Card.Body> 
             <p className="product-name-on-card">{ProductList.title}</p>
              <p className="product-price-on-card">Price : <s className="text-secondary">${ProductList.price}</s> ${ProductList.special_price}</p>
